...
class _ParameterPageState extends State<ParameterPage> {
  ...
  InputDecoration _gcsInput(String label, String hint) {
    return InputDecoration(
      ...
      labelStyle: TextStyle(color: _muted, fontSize: 3.5.sp, letterSpacing: 0.3),
      filled: true,
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(children: [
                    ...
                    _field(
                      w: 80, h: 52,
                      decoration: _gcsInput("Dönüş Başlangıç Hızı", donusBasHiz),
                      onSubmitted: (value) async {
                        setState(() { donusBasHiz = value.trim(); });
                        await Future.delayed(const Duration(milliseconds: 100));
                  ...
                  Row(children: [
                    _field(
                      ...
                      onSubmitted: (value) async {
                        setState(() { donusOnceSure = value.trim(); });
                        await Future.delayed(const Duration(milliseconds: 100));
                    ...
                    _field(
                      ...
                      onSubmitted: (value) async {
                        setState(() { liftOnceSure = value.trim(); });
                        await Future.delayed(const Duration(milliseconds: 100));
